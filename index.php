        ...
        <section class="section order">
            <div class="container">
                ...
                <div class="order__form">
                    <!--              <div class="" style="color: purple">  --><?php
//                if (isset($_POST['name'])){
//                    echo 'Спасибо за заказ '.$_POST['name'].' !';
//                }
//              ?><!--</div>-->
                    <form class="order__form-tag" id="order-form" action="burgers.php" method="post">
                        ...
                        <div class="order__form-col">
                            ...
                            <div class="order__form-buttons">
                                ...
                                <div class="g-recaptcha" data-sitekey="6Lc7LDsUAAAAAFl2nYzZCXsdj4qhtSwghSQoEKEy"></div>
                                <div class="order__form-row">
